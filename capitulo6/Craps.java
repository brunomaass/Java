...
public class Craps
{
    ...
    public static void main(String[] args)
    {
        ...
        switch (sumOfDice)
        {
            ...
            case BOX_CARS: // perde com 12 no primeiro lançamento
                ...
                break;
            default: // não ganhou nem perdeu, portanto registra a potuação
    ...
    public static int rollDice()
    {
        ...
        int die1 = 1 + randomNumbers.nextInt(6); // lança o primeiro dado
        int die2 = 1 + randomNumbers.nextInt(6); // lança o segundo dado
